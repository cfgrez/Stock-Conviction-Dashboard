...
// Gemini 3.5 Flash: modelo estable (GA desde mayo 2026) disponible en el
// free tier de Google AI Studio (sin tarjeta de crédito). gemini-2.5-flash
// dejó de estar disponible para cuentas nuevas antes de su fecha de retiro
// anunciada, así que se usa la generación 3.x.
// Se mantienen dos llamadas separadas (investigación / estructuración) en
// vez de combinar google_search + responseSchema en una sola petición:
// aunque Gemini 3.x lo soporta oficialmente, hay reportes recientes de
// fallos intermitentes con esa combinación exacta — separarlo es más lento
// pero más confiable.
...
async function onRequestPost(context) {
  ...
  const cacheKey = new Request(
    `https://cache.stock-filter.internal/v6-gemini35/${encodeURIComponent(ticker)}`,
    { method: "GET" },
  );
